...
def get_del_msg_blacklist():
    ...
    try:
        ...
        session["delete_msg_blacklist"] = collection.find_one({"title": "config"}, {"delete_msg_blacklist": 1})["delete_msg_blacklist"]
    ...
    if len(session["fast_del_msg_blacklist"]) > 0:
        ...
        collection.update_one(
            ...
            {
                "$set": {
                    "delete_msg_blacklist": session["delete_msg_blacklist"],
                    "fast_del_msg_blacklist": [],
                }
            },
            upsert=True,
