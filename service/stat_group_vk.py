...
local_pers = 0
city_raion = (
    "МалмыжСавалиКалининоСтарый ИрюкТат-Верх-ГоньбаАкбатыревоШишинер"
...
city_oblast = (
    "КировВятские ПоляныУржумКильмезьКрасная ПолянаСосновкаДонауровоВерхошижемье"
...
city_tatarstan = (
    "КазаньБалтасиНабережные ЧелныКукморНуринерИннополисШеморданМамадыш"
...
result = [
    group_name,
    "Всего подписчиков - " + str(len(persons)),
    "Мертвые души - " + str(deactivated),
    "Количество городов - " + str(len_gorod),
    "Малмыжский район - " + str(city_raion_counter),
