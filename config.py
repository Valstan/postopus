...
delete_word = (
    'Админ разместите анонимно объявление, спасибо. ', 'Не анонимно', 'Админ пропусти'
...
delete_msg_blacklist = [
    'club46644578', '89600336666', '1300 за все',
    ...
    'НОВЫЙ ВЗГЛЯД', 'ЛО-43-01-003237', '8-953-947-1198', '8-922-993-6797', 'Опубликуйте', 'пиздец', '89172420664',
    'Любишь пиво', '89520389085', 'Выкуп Авто', 'Удаленная занятость', 'наш интернет магазин', 'Без вложений',
    '89063250561', 'доборные элементы', 'выгодные покупки', 'сопровождение подписчиков', '89127181053',
