...
delete_msg_blacklist = (
    'Первом Малмыжском', 'ТЕХНО Добреев', 'Добреев', 'Добреев Малмыж', '3870096', 'Комсомольская д.50',
    'Доход от 20 000', 'Реализация Материнского Капитала', '8718228', 'Доход от 20 000', '1852040',
    '7246551', '7174175', '520-7319', 'ЩЕНКИ', 'Орифлэйм', 'первый заказ', 'Nestogen', 'Продаю смесь',
    'ул.Почтовая 10', 'Кальций в капсулах', 'Витамины для детей', 'По 850 р', '337-31-19', '7328566',
    'club46644578', '0336666', '1300 за все', 'Charon Baby', 'Салон Мебели', '5154341', 'любой аромат',
    ...
    '2фото', '450р', '4фото', '350р', 'Любое фото', '200р', 'charon baby', 'pasito',
    'МЕДИЦИНСКИЙ ЦЕНТР \"НОВЫЙ ВЗГЛЯД\"', '003237', '947-1198', '993-6797', 'Опубликуйте', 'пиздец', '2420664',
