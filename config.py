...
# Добавил сессию?
# Добавь ее аргументы в "Стартовое сообщение скрипта" в "Логины и пароли" и "Выбор базы" и в скрипт "control.py"
...
baraban = ["krugozor", "art", "krugozor", "prikol", "krugozor", "music", "krugozor", "prikol"]
